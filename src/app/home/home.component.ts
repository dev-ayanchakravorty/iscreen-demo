...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  constructor(private zone: NgZone, private router: Router, private dataService: DataService) {
    ...
    this.dataService.filterArray.subscribe((data) => {
      this.newDetails = data;
      this.charttype = this.newDetails.Charts;
      this.ApplyFilter();
  ...
  createPieChart() {
    ...
    this.chart.background.fill = am4core.color("#072f39");
    ...
    pieSeries.legendSettings.labelText = "[bold #00bfff]{name}[/]";
    pieSeries.legendSettings.valueText = "[bold #00bfff]{value}[/]";
    let hs = pieSeries.slices.template.states.getKey("hover");
    hs.properties.scale = 1;
    hs.properties.fillOpacity = 0.5;
    pieSeries.legendSettings.labelText = "[#00bfff]{name}[/]";
    ...
    this.chart.exporting.menu.items = [
      {
        ...
        "menu": [
          ...
          { "type": "xlsx", "label": "Data" },
          { "type": "pdf", "label": "PDF" },
        ]
      }
    ];
    this.chart.exporting.filePrefix = "iScreen-Pie";
  ...
  createColumnChart() {
    ...
    categoryAxis.renderer.labels.template.fill = am4core.color("#00bfff");

    let valueAxis = this.chart.yAxes.push(new am4charts.ValueAxis());
    valueAxis.title.text = "SKU";
    valueAxis.title.fontWeight = "bold";
    valueAxis.renderer.grid.template.stroke = am4core.color("#00bfff");
    valueAxis.renderer.labels.template.fill = am4core.color("#00bfff");
    ...
    series.tooltipText = "{categoryX}: [bold #00bfff]{valueY}[/]";
    series.columns.template.fillOpacity = .8;
    series.legendSettings.labelText = "[#00bfff]{name}[/]";

    let columnTemplate = series.columns.template;
    columnTemplate.strokeWidth = 2;
    columnTemplate.strokeOpacity = 1;
    columnTemplate.stroke = am4core.color("#00bfff");
    ...
    this.chart.exporting.filePrefix = "iScreen-Column";
  }
  ...
  createRadarChart() {
    ...
    this.chart.exporting.filePrefix = "iScreen-Radar";
  }
}